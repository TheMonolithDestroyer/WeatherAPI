    ...
    public static class SwaggerExtension
    {
        public static void AddSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "WeatherAPI API v1",
                    Version = "v1",
                    Description = "A v1 WebAPI for managing WeatherAPI services"
                });
        ...
        public static void UseSwaggerDocument(this IApplicationBuilder app, IWebHostEnvironment env, IConfiguration configuration)
        {
            app.UseSwagger(options =>
            {
                ...
                {
                    openApiDocument.Servers = new List<OpenApiServer> { new OpenApiServer { Url = "http://localhost:5021" } };
                });
            });
